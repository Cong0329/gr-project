...
// Selectors
export const selectMedicalRecords = (state) => state.medicalRecord.records;
...
export const selectCreateLoading = (state) => state.medicalRecord.createLoading;
export const selectCreateError = (state) => state.medicalRecord.createError;
export const selectCreateSuccess = (state) => state.medicalRecord.createSuccess;
export const selectTotalRecords = (state) => state.medicalRecord.totalRecords;
export const selectCurrentPage = (state) => state.medicalRecord.currentPage;
