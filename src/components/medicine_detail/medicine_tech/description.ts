...
export const productDescription: Description = {
    ...
    description: [
        ...
        },
        {
            ...
            title: "Lưu ý",
            image: null,
            description: "Không sử dụng cho người dị ứng với bất kỳ thành phần nào của sản phẩm."
        },
        {
