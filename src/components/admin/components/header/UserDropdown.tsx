...
export default function UserDropdown() {
  const { admin, isAuthenticated, status } = useSelector((state: RootState) => state.auth);
    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          <img src={admin?.avatar_url || avatar} alt="User" className="w-full h-full object-cover" />
        </span>
