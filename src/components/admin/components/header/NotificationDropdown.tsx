  ...
  return (
    <div className="relative z-[999]">
      ...
      <Dropdown
        ...
        className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border  border-gray-200  p-3 shadow-theme-lg sm:w-[361px] lg:right-0"
      >
            ...
            < li key={i}>
              ...
              >
                <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                  ...
                  />
                  <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-error-500 "></span>
                </span>
