...
const seasonalDiseases: Disease[] = [
  {
    ...
    description:
      "Sốt xuất huyết Dengue là một bệnh do muỗi truyền xảy ra ở các khu vực nhiệt đới và cận nhiệt đới...",
  ...
  },
  {
    ...
    name: "Ebola",
    description:
      "Ebola là một căn bệnh truyền nhiễm hiếm gặp nhưng có thể gây nguy cơ tử vong cao...",
  ...
  },
  {
    ...
    name: "Cúm",
    description:
      "Bệnh cúm là bệnh truyền nhiễm, gây ra do nhiễm virus cúm. Virus có thể gây bệnh từ nhẹ tới nặng...",
  ...
  },
  {
    ...
    description:
      "Bệnh tay, chân, miệng là bệnh do virus gây ra, có khả năng lây lan rất nhanh chóng...",
...
const targetDiseases: Disease[] = [
  {
    id: 5,
    name: "Sởi",
    description: "Sởi là một bệnh truyền nhiễm cấp tính do virus gây ra...",
  ...
  },
  {
    ...
    description:
      "Bệnh viêm não Nhật Bản có thể gây tổn thương hệ thần kinh trung ương...",
    image: "/images/japanese-encephalitis.jpg",
  },
];
...
export default function DiseaseList() {
  ...
  const diseases =
    selectedTab === "seasonal" ? seasonalDiseases : targetDiseases;
  ...
  return (
    <div className="w-4/5 md-lg:w-11/12 tb:w-11/12 container mx-auto my-5 bg-gray-100 rounded-lg">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <button className="text-blue-500 font-medium">Xem thêm &gt;</button>
      </div>
      ...
      <div className="flex gap-4 ms:gap-2 ms:text-[13px] mb-6">
        ...
        <button
          className={`px-4 py-2 rounded-full border transition ${
            selectedTab === "target" ? "bg-blue-600 text-white" : "bg-gray-200"
          }`}
      ...
      <div className="">
        <Slider {...settings}>
          {diseases.map((disease) => (
            <div
              key={disease.id}
              className=" px-3 ml:px-1 h-[335px] ml:h-[310px] "
            >
              <div className=" bg-white rounded-lg shadow-md h-full">
                <img
                  ...
                  alt={disease.name}
                  loading="lazy"
                  className="w-full h-40 ml:h-32 object-cover rounded-t-lg mb-4"
                />
                <h3 className="text-lg font-semibold md-lg:text-[15px] ml:h-14 px-2 ">
                  {disease.name}
                </h3>
                ...
                <button className="text-blue-500 font-medium px-2 ml:mt-3">
                  Tìm hiểu thêm &gt;
                </button>
              </div>
            </div>
